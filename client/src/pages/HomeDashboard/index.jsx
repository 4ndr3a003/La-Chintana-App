        ...
        <div className="bg-[var(--color-pc-yellow)] p-6 md:p-8 flex items-center gap-6 premium-header-card">
          ...
          <div>
            <div className="flex items-center gap-2 mb-1">
              <span className="bg-blue-500 dark:bg-slate-100 text-white text-xs font-bold px-2 py-0.5 rounded-full uppercase tracking-wider">
          ...
          <section className="dashboard-section">
            ...
            <div className="flex flex-col gap-4">
              {recentComms.length > 0 ? (
                ...
                // Default empty state when no communication is available
                <div className="col-span-full h-40">
