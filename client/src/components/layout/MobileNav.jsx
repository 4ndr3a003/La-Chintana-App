...
const MobileNav = () => {
  ...
  return (
    <div className="xl:hidden fixed bottom-6 left-4 right-4 bg-white/90 backdrop-blur-md border border-slate-200 shadow-2xl rounded-2xl p-2 flex justify-between items-center z-50">
      <Link
        to="/comms"
