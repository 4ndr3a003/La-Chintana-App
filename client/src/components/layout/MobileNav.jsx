      ...
      >
        ...
        {showAdmin && (
          ...
          >
            ...
            <IonLabel className={isActive('/logistics') ? "text-yellow-400 font-bold text-[0.625rem] sm:text-xs mt-1 transition-all duration-200" : "text-blue-200 dark:text-slate-400 font-medium text-[0.625rem] sm:text-xs mt-1 transition-all duration-200"}>Mezzi</IonLabel>
          </IonTabButton>
        )}
      </IonTabBar>
    </div>
